...
public class BookDao implements WorkDiv<Book>, LoggerManager {
	...
	// 저장 파일에 읽어 들인 Data : CRUD,마지막에 파일에 기록
	public static List<Book> bookList = new ArrayList<>();
	// 저장 파일 경로
	public final static String SAVE_FILE_PATH = "C:\\DCOM_20220127\\01_JAVA\\workspace\\Java_WC\\src\\com\\pcwk\\data\\books.csv";
	...
	public int readFile(String filePath) {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
			...
			while ((line = br.readLine()) != null) {
				...
				Book book = new Book(inArray[0], inArray[1], inArray[2], inArray[3], false);
				bookList.add(book);
			}
