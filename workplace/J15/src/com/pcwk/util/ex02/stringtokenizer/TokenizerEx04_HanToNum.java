...
public class TokenizerEx04_HanToNum {
	...
	//삼십만삼천백십오 (한글로 숫자 표시, 단위 표시) -> 303115
	...
	public static long hanToNum(String input) {
		long result = 0;//결과
		long tmpResult = 0;//십백쳔 단위의 값을 저장하기 위한 임시변수
		long num = 0;
		
		final String NUMBER = "영일이삼사오육칠팔구";//숫자
		final String UNIT = "십백천만억조";//단위		
		final long[] NUM_UNIT = {10,100,1000,1000,(long)1e8,(long)1e12};
		// => 단위와 NUM_UNIT 배열 인덱스로 대칭
