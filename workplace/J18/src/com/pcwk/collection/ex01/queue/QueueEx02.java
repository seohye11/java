...
//	명령어 history Queue로 생성  
	...
	static final int MAX_SIZE = 5;//Queue에 5대까지만 저장
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			try {
				...
				String input = scanner.nextLine().trim();//앞 뒤 공백 제거
	...
	/**
	 * Queue에 저장
	 * dos명령어 history : c:\User\ITSC>doskey /history
	 * @param input
	 */
