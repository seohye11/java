...
public class LinkedListEx03_PrintAll {
	...
	public static void main(String[] args) {
		...
		LinkedList<String> lectureList = new LinkedList<>(Arrays.asList
		...
		//뒤에서부터 출력 : 생성자에 출력 위치 선정 : lectureList.size()
		ListIterator<String> listIterator = 
				lectureList.listIterator(lectureList.size());
